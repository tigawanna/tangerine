...
import { pgTable, text, timestamp, boolean, decimal, jsonb, index, primaryKey, geometry, } from "drizzle-orm/pg-core";
...
export const kitchenCuisine = pgTable("kitchen_cuisine", {
